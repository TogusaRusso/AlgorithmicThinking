...
#print network
attack_order = targeted_order(network)[:network_size/5]
#print attack_order
print "Network"
resilience_network = compute_resilience(network, attack_order)
print "ER"
attack_order = targeted_order(er_graph)[:network_size/5]
resilience_er = compute_resilience(er_graph, attack_order)
print "UPA"
attack_order = targeted_order(upa_graph)[:network_size/5]
...
plot_x2 = [[idx, network_size - idx] for idx in range(network_size / 5)]
plot_x1 = [[idx, 0.75 * (network_size - idx)] for idx in range(network_size / 5)]
simpleplot.plot_lines("Graph resilience", 800, 600,
            ...
            False, ["Network example", "ER graph, p = 0.00397", "UPA graph, m = 3", "X", "0.75X"])
