...
#print network
attack_order = targeted_order(network)
#print attack_order
print "Network"
resilience_network = compute_resilience(network, attack_order)
print "ER"
attack_order = targeted_order(er_graph)
...
simpleplot.plot_lines("Graph resilience", 800, 600,
            "Nodes removed", "Size of the largest connect component",
                      [plot_network, plot_er, plot_upa], 
            False, ["Network example", "ER graph, p = 0.00397", "UPA graph, m = 3"])
